...
export class Storage {
	 ...
	 * @param {string | number | unknown[] | Record<string, unknown>} value Data to save
	 * @example Storage.set('animals', ['cats', 'dogs'])
	 * @memberof Storage
	 * @since 1.0.0
	 */
	async set(key: string, value: string | number | unknown[] | Record<string, unknown>): Promise<void> {
		await Promise.resolve();
